package com.weijuju.iag.projectmanager.web;/**
...
public class WebConfig  extends WebMvcConfigurerAdapter implements ServletContextAware{
    ...
    private static String REDIS_VERSION_KEY="projectmanager:version";

    private static String REDIS_VERSION_TOP_KEY="projectmanager:version:top";


    @Value("${StaticResourcesUrl}")
